...
final class AdvertisementCell: BaseCollectionViewCell {
    
    private var adImage: AdImagesCell.Item = .init(image: "No image", url: "Url")
    ...
    private lazy var imageCollectionView: UICollectionView = {
        ...
        collectionView.register(AdImagesCell.self, forCellWithReuseIdentifier: AdImagesCell.identifier)
    ...
    private func setupUI() {
        ...
        [topStackView, imageCollectionView, bottomStackView, containerView].forEach(contentView.addSubview)
        ...
        bottomStackView.snp.makeConstraints { make in
            make.top.equalTo(imageCollectionView.snp.bottom).offset(13)
...
extension AdvertisementCell: UICollectionViewDataSource, UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        let count = 1
        
        currentPageLabel.text = "1/\(count)"
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell: AdImagesCell = collectionView.dequeueCell(with: indexPath)
        cell.configure(adImage)
